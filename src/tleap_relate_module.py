...
class Tleap_runner:
    def __init__(self, automd_home, forcefields, external_amberparms, external_amberprep, rec_name_u, lig_name, boxtype, boxsize, sbond_file):
    ...
    def generate_tleap_file(self):
        ...
        with open(os.path.join(self.automd_home, 'src', 'template_files', 'tleap.template'), "r") as template_file, open("tleap.txt", "a") as file:
            for line in template_file:
                ...
                line = line.replace("_BOXTYPE_", self.boxtype).replace("_BOXSIZE_", str(self.boxsize))
                file.write(line)
