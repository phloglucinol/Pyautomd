...
class PrepiGenerator:
    ...
    """
    def __init__(self, pdb, resn, charge_method='bcc', lig_ff='gaff', gau=None):
        """
    ...
    def run_antechamber(self, fi, fo, i, o, c, rn=None, rf=None, at=None, cf=None):
        """
    ...
    def gen_nonstandard_amino_acid_prepi(self):
        ...
        if self.charge_method == 'resp':
            ...
            self.run_antechamber(fi="gout", fo="ac", i=self.gau, o=f"{self.prefix}.ac", c="resp")
    ...
    def gen_small_molecule_prepi(self):
        ...
        """
        if self.charge_method == 'resp':
            self.run_antechamber(fi="gout", fo="ac", i=self.gau, o=f"{self.prefix}.ac", c="resp", rn=self.resn, rf='\"\"',at=self.lig_ff)
            self.run_antechamber(fi="gout", fo="prepi", i=self.gau, o=f"{self.prefix}.prepi", c="resp", rn=self.resn, rf='\"\"', at=self.lig_ff)
        elif self.charge_method == 'bcc':
            self.run_antechamber(fi="pdb", fo="ac", i=self.pdb, o=f"{self.prefix}.ac", c="bcc", rn=self.resn, at=self.lig_ff)
            self.run_antechamber(fi="pdb", fo="prepi", i=self.pdb, o=f"{self.prefix}.prepi", c="bcc", rn=self.resn, at=self.lig_ff)
        else:
